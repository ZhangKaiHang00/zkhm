...
<body>
	...
	<table class="table table-bordered table-hover">
		<tr align="center">
			...
			<td>文章内容</td>
			<td>投诉类型</td>
			<td><a href="javascript:myOrder('complain_num')">投诉次数</a></td>
			<td>投诉详情</td>
			<td>操作</td>
		</tr>
		<c:forEach items="${info.list}" var="u" varStatus="i">
			<tr align="center">
				...
				<td><a href="admin/article/select1?id=${u.id}" target="_bar">详情</a></td>
				...
				<c:if test="${u.article.status==2}">
				 <button type="button" class="btn btn-warning" onclick="update(${u.article.id},this)">禁止</button>
